...
public class Fishing {
    ...
    ArrayList<Integer> rewardPointsList = new ArrayList<Integer>(Arrays.asList(0,100,200,300,350,400,450,500,550,600,2000));
    ...
    public Fishing(){
        ...
        critterList.put(100,new ArrayList<String>(Arrays.asList("<:Blobfish:1000450952014340208>","<:Snail:1000450934142406706>","<:Largemouth_Bass:1002340394308218930>","<:Pufferfish:1000450059709714533>")));
        critterList.put(200,new ArrayList<String>(Arrays.asList("<:Squid:1000449747720605707> ","<:Shrimp:1000450967218704414>")));
        critterList.put(300,new ArrayList<String>(Arrays.asList("<:Crab:1000451591612153876>")));
        critterList.put(350,new ArrayList<String>(Arrays.asList("<:Red_Mullet:1000450076063322142>")));
        critterList.put(400,new ArrayList<String>(Arrays.asList("<:Lobster:1000451468479975474>")));
        critterList.put(450,new ArrayList<String>(Arrays.asList("<:Tuna:1000449767278661863>")));
        critterList.put(500,new ArrayList<String>(Arrays.asList("<:Lionfish:1002340374297194508>")));
        critterList.put(550,new ArrayList<String>(Arrays.asList("<:Legend_II:1002341989087444993>")));
        critterList.put(600,new ArrayList<String>(Arrays.asList("<:Gold_Nugget:1002341957261070416>")));
        critterList.put(2000,new ArrayList<String>(Arrays.asList("<:Diamond:1002340462721515630>")));
    }
        ...
        if(validBalance(server,event)){
            ...
            if(didUserWin()){
                event.getChannel().sendMessage("Congratulations you caught a: " + getCritter() +
                        " you earned " + userReq + " after Sussy Tax").queue();
                updateCredits(server,event, userReq, true);
            }
            else{
                event.getChannel().sendMessage("You caught a: " + getCritter() + " which is illegal under Sussy conservation laws, you have been fined 400 credits !holdL <a:policeBear:1002340283364671621>").queue();
